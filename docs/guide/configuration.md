...
| `MCP_V2_EXPERIMENTAL`                                                                                  | Experimental | Enables opt-in dual-era HTTP and stdio support for MCP `2026-07-28`; legacy behavior remains the default. See [MCP protocol compatibility](../reference/mcp-protocol-compatibility.md). |
