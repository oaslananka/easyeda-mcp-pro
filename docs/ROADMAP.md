...
| --------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| **v1.0.0 — Release stabilization and promotion**    | Not scheduled | [Epic #420](https://github.com/oaslananka/easyeda-mcp-pro/issues/420) · [Release gate #554](https://github.com/oaslananka/easyeda-mcp-pro/issues/554)                       | Verify the next release candidate, complete the required release gates, and decide stable v1.0 promotion. |
