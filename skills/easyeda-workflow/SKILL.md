...
8. Validate after mutation with schematic netlist, DRC/ERC, board constraint, and production checks. Do this after *every* batch write, not just at the end — see "Known write-safety caveats" above for why a write's own return value cannot be trusted alone.
