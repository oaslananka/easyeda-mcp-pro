...
| --------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| **v1.0.1 — Patch stabilization and promotion**      | Not scheduled | [Release gate #561](https://github.com/oaslananka/easyeda-mcp-pro/issues/561)                                                                                               | Promote the verified RC.1 to stable 1.0.1 without runtime changes and keep release evidence current. |
